...
'Call test case login để dùng test case me'
...
'Call test case me để lấy id'
WebUI.callTestCase(findTestCase('authentiaction-management/TC_me'), [('statusCode') : '200'], FailureHandling.STOP_ON_FAILURE)

'Gửi request get user với id được lấy từ me'
ResponseObject responseGetUser = WS.sendRequest(findTestObject('user-management/get-user', [('id') : GlobalVariable.id]))
